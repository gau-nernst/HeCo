...
class ContrastDrop(Contrast):
    def forward(self, z_mp1, z_mp2, z_sc1, z_sc2, pos, beta1, beta2):
...
class HeCoDrop(HeCo):
    ...
    def forward(self, feats, pos, mps, nei_index, beta1, beta2):
        ...
        loss = self.contrast(z_mp1, z_mp2, z_sc1, z_sc2, pos, beta1, beta2)
        return loss
